    ...
    public class DataPanel extends JPanel
    {
        ...
        private DataPanel()
        {
            ...
            this.runButton.addActionListener(new ActionListener()  {
                ...
                public void actionPerformed(ActionEvent e)
                {
                    ...
                    String buttonState = runButton.getText();
                    
                    // If button is pushed when it says "Start"
                    ...
                    // If button is pushed when it says "Stop"
                    else
                    {
                        // Stop timer
                        timer.stop();
        ...
        public void setTime(int newTime)
        {
            ...
            if (InfantFrame.this.trial != null)
            {
                ...
                // If time is valid
                if (newTime < InfantFrame.this.trial.getSize())
                {
                    // Set current time to new time
                    currentTime = newTime;
                    
                    // Set slider to new time
                    timeSlider.setValue(newTime);
                    
                    // Update display
                    this.update(InfantFrame.this.trial.getItem(newTime));
                }
                
                // Time is not in the allowable range
                else
                {
                    timer.stop();
                }
        ...
        {
            KinematicPointConstant root = new KinematicPointConstant(Color.RED, LINE_WIDTH, 0, 0, 0);
            Integer time = new Integer(currentTime);
            ...
            **/
            ...
            // Initialize all kinematic points
            KinematicPointConstant lowerBack = new KinematicPointConstant(Color.RED, LINE_WIDTH, 0.1, 0, 0);
            KinematicPointConstant rightHip = new KinematicPointConstant(Color.RED, LINE_WIDTH, 0, -0.05, 0);
            KinematicPointConstant leftHip = new KinematicPointConstant(Color.RED, LINE_WIDTH, 0, 0.05, 0);
            KinematicPointState upperBack = new KinematicPointState(Color.BLUE, LINE_WIDTH, "upper_back");
            KinematicPointState leftShoulder = new KinematicPointState(Color.ORANGE, LINE_WIDTH, "left_shoulder");
            KinematicPointState rightShoulder = new KinematicPointState(Color.PINK, LINE_WIDTH, "right_shoulder");
            KinematicPointState rightElbow = new KinematicPointState(Color.PINK, LINE_WIDTH, "right_elbow");
            KinematicPointState leftElbow = new KinematicPointState(Color.ORANGE, LINE_WIDTH, "left_elbow");
            KinematicPointState rightWrist = new KinematicPointState(Color.PINK, LINE_WIDTH, "right_wrist");
            KinematicPointState leftWrist = new KinematicPointState(Color.ORANGE, LINE_WIDTH, "left_wrist");
            KinematicPointState rightKnee = new KinematicPointState(Color.PINK, LINE_WIDTH, "right_knee");
            KinematicPointState leftKnee = new KinematicPointState(Color.ORANGE, LINE_WIDTH, "left_knee");
            KinematicPointState rightAnkle = new KinematicPointState(Color.PINK, LINE_WIDTH, "right_ankle");
            KinematicPointState leftAnkle = new KinematicPointState(Color.ORANGE, LINE_WIDTH, "left_ankle");
            KinematicPointState rightFoot = new KinematicPointState(Color.PINK, LINE_WIDTH, "right_foot");
            KinematicPointState leftFoot = new KinematicPointState(Color.ORANGE, LINE_WIDTH, "left_foot");
            
            // Add children to parents
            root.addChild(lowerBack);
            root.addChild(upperBack);
        ...
        private void update(State state)
        {
            ...
            infantTextField.setText("Infant: " + state.getTrial().getInfantID());
            timeTextField.setText("Time Step: " + String.valueOf(currentTime));
